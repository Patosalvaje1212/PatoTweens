    ...
    public class Tween : IPTween
    {
        ...
        public static float EaseMult(EaseType easingType, float t)
        {
            return easingType switch
            {
                ...
                EaseType.InElasticOvershoot => InElasticOvershoot(t), 
                EaseType.OutElasticOvershoot => OutElasticOvershoot(t), 
                EaseType.InOutElasticOvershoot => InOutElasticOvershoot(t), 
                EaseType.InSinusoidal => InSinusoidal(t), 
                EaseType.OutSinusoidal => OutSinusoidal(t), 
                EaseType.InOutSinusoidal => InOutSinusoidal(t), 
